...
# ========================
# Не импортируйте этот модуль в hosts/default.nix, пока не подставите MAC
# Bluetooth-адаптера ЭТОЙ машины и актуальные ключи устройств.
# Иначе сопряжение на новом ПК будет работать некорректно.
# ========================
